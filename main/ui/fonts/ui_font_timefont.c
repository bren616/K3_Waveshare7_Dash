 ...
 * Size: 96 px
 * Bpp: 4
 * Opts: --bpp 4 --size 96 --font G:/My Drive/Arduino_2026/k3_dash_2026_ui/assets/Montserrat-Regular.ttf -o G:/My Drive/Arduino_2026/k3_dash_2026_ui/assets\ui_font_timefont.c --format lvgl --symbols 1234567890+-. --no-compress --no-prefilter
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 883, .box_w = 43, .box_h = 42, .ofs_x = 6, .ofs_y = 13},
    {.bitmap_index = 903, .adv_w = 587, .box_w = 26, .box_h = 6, .ofs_x = 5, .ofs_y = 23},
    {.bitmap_index = 981, .adv_w = 326, .box_w = 11, .box_h = 11, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 1042, .adv_w = 1017, .box_w = 55, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 2940, .adv_w = 554, .box_w = 24, .box_h = 67, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3744, .adv_w = 872, .box_w = 50, .box_h = 68, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 5444, .adv_w = 866, .box_w = 50, .box_h = 68, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 7144, .adv_w = 1015, .box_w = 60, .box_h = 67, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 9154, .adv_w = 869, .box_w = 49, .box_h = 68, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 10820, .adv_w = 935, .box_w = 52, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 12614, .adv_w = 905, .box_w = 50, .box_h = 67, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 14289, .adv_w = 980, .box_w = 53, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 16118, .adv_w = 935, .box_w = 52, .box_h = 69, .ofs_x = 2, .ofs_y = -1}
};
